...
colon.clu <- read.csv('outputs/colon_clu.csv', header = F)
...
retina.clu <- read.csv('outputs/retina_clu.csv', header = F)
```
...
```{r}
write.csv(data.frame(colon_zinbwave@reducedDims$zinbwave), file = 'outputs/colon_ZINB-WAVE.csv', row.names = F) # colon data

write.csv(data.frame(retina_zinbwave@reducedDims$zinbwave), file = 'outputs/retina_ZINB-WAVE.csv', row.names = F) # retina data
```
...
write.csv(retina_glmpca$factors, file = 'outputs/retina_GLM-PCA.csv', row.names = F) # retina data
```
